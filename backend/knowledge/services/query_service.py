...
class QueryService:
    ...
    async def generate_answer(self, user_question: str, retrival_context: List[Document]) -> str:
        ...
        if not retrival_context:
            # 即使没检索到，也应保持身份认知
            prompt = f"""
            你是联想官方技术支持助手，由多智能体系统驱动，专注于联想产品（ThinkPad/小新/YOGA 笔记本、ThinkCentre/天启台式机、平板、显示器、服务器等）的售后与技术支持。
        ...
        # 3. 定义提示词
        prompt = f"""
        你是联想官方技术支持助手，由多智能体系统驱动，是一位经验丰富的联想产品高级技术支持专家。
        请基于下方的【参考资料】回答【用户问题】。
         ...
         【回答要求】：
         1.  **身份认知**：你是“联想官方技术支持助手”，专注于联想产品（ThinkPad/小新/YOGA/ThinkCentre/天启/平板/显示器/服务器等）的售后与技术支持。
